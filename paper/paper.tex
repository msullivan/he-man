...
\bnf{
\i{Stmt}
\p{\b{Decl} (\i{Var}, \i{Type}) \i{DExpr}}
\a{\b{While} \i{DExpr} [\i{Stmt}]}
\a{\b{If} \i{DExpr} [\i{Stmt}] [\i{Stmt}]}
\a{\b{Spawn} ([(\i{Var}, \i{Type})], [\i{Stmt}]) [\i{DExpr}]}
\a{\b{Assign} \i{DExpr} \i{DExpr}}
\a{\b{Exp} \i{DExpr}}
\a{\b{Wait} \i{DExpr}}
\a{\b{Exit}}
\i{DExpr}
\p{\b{Call} \i{String} [\i{DExpr}]}
\a{\b{Arith} \i{ArithOp} \i{DExpr} \i{DExpr}}
\a{\b{ArithUnop} \i{ArithUnop} \i{DExpr}}
\a{\b{RelnOp} \i{RelnOp} \i{DExpr} \i{DExpr}}
